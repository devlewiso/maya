...
import { tzutujilLessons } from '../content/tzutujilLeccion';
...
export default function TzutujilLeccionPage() {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {selectedLesson.content.vocabulary.map((item: VocabularyItem, index: number) => (
              <div key={index} className="bg-white dark:bg-gray-700 p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <p className="text-lg font-bold text-purple-600 dark:text-purple-400">{item.tzutujil}</p>
                    ...
                    <div key={itemIndex} className="p-3 bg-gray-50 dark:bg-gray-600 rounded-lg">
                      ...
                      {item.answer && (
                        <details className="mt-2">
                          <summary className="text-purple-600 dark:text-purple-400 cursor-pointer">Ver respuesta</summary>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <section className="relative py-16 md:py-24">
        <div className="absolute inset-0 z-0 bg-purple-600 opacity-10"></div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-block p-2 bg-purple-100 dark:bg-purple-900 rounded-full mb-4">
              <div className="w-16 h-16 flex items-center justify-center rounded-full bg-purple-600 text-white">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              Lecciones de Tz&apos;utujil
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Explora nuestras lecciones interactivas para aprender Tz&apos;utujil, un idioma maya hablado por más de 100,000 personas en la región del Lago Atitlán en Guatemala.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {tzutujilLessons.map((lesson: Lesson) => (
            <div 
              key={lesson.id}
              className={`bg-white dark:bg-gray-700 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 cursor-pointer ${selectedLesson?.id === lesson.id ? 'ring-2 ring-purple-500' : ''}`}
              onClick={() => handleLessonSelect(lesson)}
            >
              <div className="h-3 bg-purple-600"></div>
              <div className="p-6">
                <div className="flex items-center mb-2">
                  <span className="w-8 h-8 flex items-center justify-center rounded-full bg-purple-100 dark:bg-purple-800 text-purple-600 dark:text-purple-400 font-bold text-sm mr-3">
                    {lesson.id}
                  </span>
                ...
                <Link href={`#lesson-${lesson.id}`} className="w-full py-2 bg-purple-50 dark:bg-purple-900 text-purple-600 dark:text-purple-400 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-800 transition duration-300 text-sm font-medium inline-block text-center">
                  Ver lección
                </Link>
              </div>
            </div>
      ...
      <section className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-gray-700 rounded-xl shadow-md overflow-hidden">
          <div className="md:flex">
            <div className="md:flex-shrink-0 flex items-center justify-center p-6 bg-purple-50 dark:bg-purple-900">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                El Tz&apos;utujil tiene sonidos únicos que no existen en español. Escucha nuestras grabaciones de audio para mejorar tu pronunciación y acento.
              </p>
              <a href="#" className="inline-flex items-center text-purple-600 dark:text-purple-400 font-medium">
